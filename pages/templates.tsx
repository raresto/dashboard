...
export const templates: TemplateCardProps[] = [
  ...
  },
  {
    ...
    title: "Create React App JavaScript Starter",
    homepage: "https://nft-gallery.thirdweb-preview.com/",
    repo: "https://github.com/thirdweb-example/nft-gallery",
    description: "thirdweb starter project with Create React App & JavaScript",
    img: "/assets/templates/starter-preview.png",
    hoverBorderColor: "hsl(309deg 54% 81% / 15%)",
    tags: ["Starter", "JavaScript", "React"],
  },
  {
    id: "cra-typescript-starter",
    title: "Create React App TypeScript Starter",
    homepage: "https://cra-javascript-starter.thirdweb-example.com/",
    repo: "https://github.com/thirdweb-example/nft-gallery",
    description: "thirdweb starter project with Create React App & TypeScript",
    img: "/assets/templates/starter-preview.png",
    hoverBorderColor: "hsl(309deg 54% 81% / 15%)",
    tags: ["Starter", "TypeScript", "React"],
  },
  {
    ...
    homepage: "https://nft-gallery.thirdweb-preview.com/",
    repo: "https://github.com/thirdweb-example/nft-gallery",
    description: "thirdweb starter project with Next & JavaScript",
    img: "/assets/templates/starter-preview.png",
    hoverBorderColor: "hsl(309deg 54% 81% / 15%)",
    tags: ["Starter", "JavaScript", "Next"],
  },
  {
    ...
    homepage: "https://nft-gallery.thirdweb-preview.com/",
    repo: "https://github.com/thirdweb-example/nft-gallery",
    description: "thirdweb starter project with Next & TypeScript",
    img: "/assets/templates/starter-preview.png",
    hoverBorderColor: "hsl(309deg 54% 81% / 15%)",
    tags: ["Starter", "TypeScript", "Next"],
  },
];
